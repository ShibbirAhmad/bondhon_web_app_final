  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link v-if="$can('create credit')" :to="{ name: 'creditAdd' }" class="btn btn-primary"
            ><i class="fa fa-plus"></i
          ></router-link>

          <router-link v-if="$can('manage debit')" :to="{ name: 'debit' }" class="btn btn-info">Debit</router-link>
