  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link v-if="$can('create debit')" :to="{ name: 'debitAdd' }" class="btn btn-primary"
            ><i class="fa fa-plus"></i
          ></router-link>
            <router-link :to="{ name: 'credit' }" class="btn btn-info"
            >Credit</router-link>
             <button v-if="$can('manage credit')" @click="exportDebit" class="btn btn-success"> <i class="fa fa-download"></i> Exprot Debit</button>
        </h1>
        <ol class="breadcrumb">
          <li>
