    ...
    <div>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    <router-link :to="{name:'account_purpose'}" class="btn btn-primary"><i class="fa fa-arrow-left"></i></router-link>
                </h1>
                <ol class="breadcrumb">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <form v-else @submit.prevent="add" @keydown="form.onKeydown($event)"
                                    ...
                                    <div class="form-group">
                                        <label for="purpose type"> account purpose type</label>
                                         <select required name="type" class="form-control" v-model="form.type">
