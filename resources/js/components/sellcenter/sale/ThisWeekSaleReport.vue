                ...
                <div class="box-body">
                  <table class="table table-striped text-center table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr
                        v-for="(item, index) in this_week_sales_products"
                        v-else
                        :key="index"
                      >
  ...
  methods: {
    salesList() {
      axios.get("/api/sellcenter/sale/reports/analysis")
        .then((resp) => {
          console.log(resp);
          this.this_week_sales_products = resp.data.this_week_sales_products;
