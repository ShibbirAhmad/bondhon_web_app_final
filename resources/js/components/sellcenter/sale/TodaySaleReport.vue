                  ...
                  <table class="table table-striped text-center table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>{{ (purchasePrice(item.purchase_items) * salesQuantity(item.today_sales)).toFixed(2) }}</td>
                        <td>{{ salesQuantity(item.today_sales) }}</td>
                        <td>{{ salesAmount(item.today_sales) }}</td>
                        <td>{{ (salesAmount(item.today_sales) - ( purchasePrice(item.purchase_items) * salesQuantity(item.today_sales))).toFixed(2) }}  </td>
