                  ...
                  <table class="table text-center table-bordered table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr v-for="(supplier, index) in suppliers.data" v-bind:key="index">
                        ...
                        <td> <router-link style="color:blue" :to="{name:'SupplierAmount',params:{id:supplier.id}}" > {{ supplier.name }} </router-link></td>
...
export default {
  ...
  methods: {
    ...
    searchSupplier(page=1){
       axios.get('/api/search/supplier/'+this.search+'?page='+page)
       .then(resp => {
         console.log(resp);
