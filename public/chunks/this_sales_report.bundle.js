(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["this_sales_report"],{
  ...
  methods: {
    salesList: function salesList() {
      ...
      axios.get("/api/sellcenter/sale/reports/analysis").then(function (resp) {
        ...
        _this.total_profit = resp.data.this_month_profit;
        _this.loading = false;
      });
    },
              ...
              _c("div", { staticClass: "col-lg-11 col-md-11 " }, [
                _c("div", { staticClass: "box box-primary" }, [
                  _c(
                    ...
                    [
                      _c("h4", [_vm._v(" Sales Report This Month ")]),
                      _vm._v(" "),
                      _c("h4", [
                        _vm._v(
                          " Total Profit : " + _vm._s(_vm.total_profit) + " "
                        )
                      ])
                    ]
                  ),
...
var staticRenderFns = [
  function() {
    ...
    return _c("ol", { staticClass: "breadcrumb" }, [
      ...
      _vm._v(" "),
      _c("li", { staticClass: "active" }, [_vm._v("sales report ")])
    ])
  },
  function() {
    var _vm = this
